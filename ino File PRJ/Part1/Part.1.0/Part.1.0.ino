...
void KURANGI_SALDO(){
  ...
  void VALIDASIDATA(){
    ...
    if (client.connect(server, 80)) {    
    Serial.print("GET Connect");
    client.println("GET /Arduino/Validasi.php?data1="+bacadata+" HTTP/1.0");
    client.println(host);
    client.println("Connection: close");
    client.println();
   ...
   String data= client.readString();
      ...
      Serial.print(data.length());
      Serial.print("----------");
      c= data.substring(174); //Karakter Statis
      c.trim();    
      //String i= data.substring(1); //DHC Karakter
      Serial.print("----Jumlah Karakter------");
      Serial.print(c);
...
void GETSALDOonly(){
  bacadata.trim();    
   ...
   String x="";
      ...
      Serial.print(data.length());
      Serial.print("----------");
      x= data.substring(274); //Karakter Statis
      x.trim();    
      //String i= data.substring(1); //DHC Karakter
      Serial.print("----Jumlah KarakterSALDOONLY------");
      Serial.print(x);
...
//    if (client.connect(server, 80)) {    
//    Serial.print("GET Connect");
//    client.println("GET /Arduino/HIGH.txt HTTP/1.1");
//    client.println(host);
//    client.println("Connection: close");
//    client.println();
//
...
//      Serial.print(data.length());
//      Serial.print("----------");
//      x= data.substring(342); //Karakter Statis
//      x.trim();    
//      //String i= data.substring(1); //DHC Karakter
//      Serial.print("----Jumlah Karakter------");
//      Serial.print(x);
...
//      saldonum=x.toInt();
//      String s="";
//      s=String(ltos(x.toInt(), buf, 10));
//       cetak("Sisa Saldo"," Rp. "+s);
//      Serial.print("@__\n");
//    }else{
//     cetak("EROR VALSI!!","Unconnected!!");
//     delay(1000);
