...
<body  onload="" class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        <?php
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1> Dashboard <small><?php if (isset($header)) echo $header; else echo "";?></small></h1>
                <ol class="breadcrumb">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019 <a href="<?php echo base_url();?>">SMARTTRASH</a>.</strong>  All rights reserved.
        </footer>
